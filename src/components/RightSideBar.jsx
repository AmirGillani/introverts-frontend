...
export default function RightSide() {
  return (
    <div className="md:flex hidden flex-col gap-3 relative z-10 items-center w-[80%]">
      ...
      <button className="w-full bg-gradient-to-b from-[#f99827] to-[#f95f35] text-white  p-0.5 rounded-sm cursor-pointer hover:bg-gradient-to-b hover:from-white hover:to-white hover:border-orange hover:border-2 hover:text-orange py-2">
        Share
      </button>
    </div>
  );
