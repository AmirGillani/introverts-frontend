...
import { getAllUsers, followUser, unFollowUser,getSingleUser } from "../REDUX/authReducer";
...
export default function FollowersCard() {
  ...
  return (
    <div className="w-full p-2 relative z-10 h-[60vh]">
